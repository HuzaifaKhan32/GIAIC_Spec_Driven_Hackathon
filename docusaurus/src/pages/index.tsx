      ...
      <main>
        ...
        <section className="hero-section">
          <div className="container">
            <h1 className="hero-title">AI Robotics: The Definitive Guide</h1>
            ...
            <a href="/docs/intro-physical-ai" className="hero-button">
              Explore the Future
            </a>
            <div 
