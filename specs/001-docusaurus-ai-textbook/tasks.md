...
- [ ] TASK-05-01 Define root CSS variables for colors/spacing in `docusaurus/src/css/custom.css`
- [ ] TASK-05-02 Implement Dark Mode specific overrides in `docusaurus/src/css/custom.css`
- [ ] TASK-05-03 Implement Light Mode specific overrides in `docusaurus/src/css/custom.css`
- [ ] TASK-05-04 [P] Create typography styles (headings, body) in `docusaurus/src/css/custom.css`
- [ ] TASK-05-05 Apply custom styles to Markdown content area in `docusaurus/src/css/chapters.css`
- [ ] TASK-05-06 Implement Chatbot widget specific styles in `docusaurus/src/css/chatbot.css`
- [ ] TASK-05-07 [P] Implement accessibility focus states and reduced motion in `docusaurus/src/css/accessibility.css`
- [ ] TASK-05-08 Verify Zero-Flicker script in `docusaurus/docusaurus.config.js` or `src/theme/Root.js`
